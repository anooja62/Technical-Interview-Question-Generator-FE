  ...
  return (
    <div className="h-[50vh] bg-gradient-to-b from-blue-50 via-white to-purple-100 px-4 py-12 flex items-center justify-center">
      ...
      {paginatedQuestions.map((q, index) => (
        <div
          key={index}
          className="w-full max-w-3xl mt-8 bg-white rounded-xl shadow-md hover:shadow-xl transform hover:-translate-y-1 hover:scale-[1.02] transition duration-300 p-6"
        >
          <QuestionCard
            {...q}
